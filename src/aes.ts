...
import { WebCryptoCipherMode } from './webcrypto';
import {
  validateByteLength,
...
// mapped variants from
// https://github.com/nodejs/node/blob/a3ee1870fd7b8fbe9afb94d9d9ddd7be4dfa1f02/src/crypto/crypto_aes.h#L18
...
// const { AESCipherJob, KeyObjectHandle, kCryptoJobAsync } = NativeQuickCrypto;
...
// const { generateKey: _generateKey } = require('internal/crypto/keygen');

// const kMaxCounterLength = 128;
// const kTagLengths = [32, 64, 96, 104, 112, 120, 128];
// const generateKey = promisify(_generateKey);

function getAlgorithmName(name: string, length: number) {
  switch (name) {
    case 'AES-CBC':
      return `A${length}CBC`;
    case 'AES-CTR':
...
// function getVariant(name: string, length: number) {
//   switch (name) {
//     case 'AES-CBC':
//       switch (length) {
//         case 128:
//           return AESKeyVariant.kKeyVariantAES_CBC_128;
//         case 192:
//           return AESKeyVariant.kKeyVariantAES_CBC_192;
//         case 256:
//           return AESKeyVariant.kKeyVariantAES_CBC_256;
//       }
//       break;
//     case 'AES-CTR':
//       switch (length) {
//         case 128:
//           return AESKeyVariant.kKeyVariantAES_CTR_128;
//         case 192:
//           return AESKeyVariant.kKeyVariantAES_CTR_192;
//         case 256:
//           return AESKeyVariant.kKeyVariantAES_CTR_256;
//       }
//       break;
//     case 'AES-GCM':
//       switch (length) {
//         case 128:
//           return AESKeyVariant.kKeyVariantAES_GCM_128;
//         case 192:
//           return AESKeyVariant.kKeyVariantAES_GCM_192;
//         case 256:
//           return AESKeyVariant.kKeyVariantAES_GCM_256;
//       }
//       break;
//     case 'AES-KW':
//       switch (length) {
//         case 128:
//           return AESKeyVariant.kKeyVariantAES_KW_128;
//         case 192:
//           return AESKeyVariant.kKeyVariantAES_KW_192;
//         case 256:
//           return AESKeyVariant.kKeyVariantAES_KW_256;
//       }
//       break;
//   }
// }
...
//     throw new Error('AES-CTR algorithm.length must be between 1 and 128');
//   }
...
// async function asyncAesGcmCipher(
//   mode: WebCryptoCipherMode,
//   key,
//   data: Buffer,
//   {
//     iv,
//     additionalData,
//     tagLength = 128,
//   }: { iv: Buffer; additionalData: Buffer; tagLength: number }
// ) {
//   if (!kTagLengths.includes(tagLength)) {
//     throw new Error(`${tagLength} is not a valid AES-GCM tag length`);
//   }
...
//   let tag;
//   switch (mode) {
//     case WebCryptoCipherMode.kWebCryptoCipherDecrypt: {
//       // TODO: Check if this is really getting the tag from the buffer
...
//       break;
//     }
//     case WebCryptoCipherMode.kWebCryptoCipherEncrypt:
//       tag = tagByteLength;
//       break;
//   }
...
async function aesGenerateKey(
  ...
  if (hasAnyNotIn(usagesSet, checkUsages)) {
    throw new Error('Unsupported key usage for an AES key');
  }
...
//   const checkUsages = ['wrapKey', 'unwrapKey'];
//   if (name !== 'AES-KW') ArrayPrototypePush(checkUsages, 'encrypt', 'decrypt');
